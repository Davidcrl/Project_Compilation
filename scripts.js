    ...
    switch (term) {
        case "prelim":
            projectsContainer.innerHTML = `
                ...
                <embed src="./ELMS Activities/01elmsAct2-micro.pdf" type="application/pdf" width="100%" height="600px" />
                <br>
                <h2>02 eLMS Activity 2</h2>
                <embed src="./ELMS Activities/Ibarra-02elmsAct2-Microprocessors.pdf" type="application/pdf" width="100%" height="600px" />
                <br>
                <h2>02 Task Performance 1</h2>
                <embed src="./ELMS Activities/02TP-micro.pdf" type="application/pdf" width="100%" height="600px" />
                `;
            break;
        case "midterm":
            projectsContainer.innerHTML = `
                ...
                <img src="./Memory Buses slides/1.png" alt="Prelim Image" width="100%" />
                <img src="./Memory Buses slides/2.png" alt="Prelim Image" width="100%" />
                <img src="./Memory Buses slides/3.png" alt="Prelim Image" width="100%" />
                <img src="./Memory Buses slides/4.png" alt="Prelim Image" width="100%" />
            `;
            break;
        case "pre-finals":
            projectsContainer.innerHTML = `

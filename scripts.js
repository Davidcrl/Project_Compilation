    ...
    switch (term) {
        case "prelim":
            projectsContainer.innerHTML = `
                ...
                <embed src="./rachelle/ELMS Activities/Ibarra-02elmsAct2-Microprocessors.pdf" type="application/pdf" width="100%" height="600px" />
                <br>
        ...
        case "midterm":
            projectsContainer.innerHTML = `
                ...
                <img src="./rachelle/Memory Buses slides/2.png" alt="Prelim Image" width="100%" />
